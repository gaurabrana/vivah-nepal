...
if (isset($_SESSION['phpstartup_adminid'])) {
    ...
    if(isset($_GET['id']))    {
        ...
        echo "<script> location.href='manage-event.php'; </script>";    
    }
} else {
    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                    ...
                    <div class="col-md-6 col-sm-12">                        
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="manage-event.php">Manage Event</a></li>
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <h4 class="text-blue h4">Update Event Details</h4>
                </div>
