	...
	<div class="pd-ltr-20 xs-pd-20-10">
		<div class="min-height-200px">
			<div class="page-header">
				<div class="row">
					<div class="col-md-6 col-sm-12">
						<div class="title">
							<h4>Manage Cancelled Booking</h4>
						</div>
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="index.html">Home</a></li>
								<li class="breadcrumb-item active" aria-current="page">Manage Cancelled Booking</li>
							</ol>
						</nav>
					</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h4 class="text-blue h4">Manage Cancelled Booking</h4>
				</div>
				<div class="pb-20">
					...
					<table class="table hover multiple-select-row data-table-export nowrap">
						...
						<tbody>
							...
							$sql = "SELECT users.name,users.mobile,users.age,users.email,booking.id as bid,booking.bookingId,booking.bookingDate,booking.status from booking join users on users.id=booking.userId where booking.status='Cancelled' order by booking.id desc ";
