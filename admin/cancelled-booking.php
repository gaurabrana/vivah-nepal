				...
				<div class="pb-20">
					...
					<table class="table hover multiple-select-row data-table-export nowrap">
						...
						<tbody>
							...
							$sql = "SELECT users.name,users.mobile,users.email,booking.id as bid,booking.bookingId,booking.bookingDate,booking.status from booking join users on users.id=booking.userId where booking.status='Cancelled' order by booking.id desc ";
